...
\def \projecttitle       {Algebraic Curves}
\def \projectsubtitle    {and their applications in coding theory}
...
\begin{appendices}
\label{Appendices}
\include{app/fields_and_multivariate_polynomials}
\include{app/toc}
