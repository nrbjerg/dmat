...
\def \projecttitle       {Algebraic Geometry Codes}
\def \projectsubtitle    {Applications of Algebraic Curves in Coding Theory}
\def \projecttheme       {Algebraic Geometry Codes}
\def \projectdegree      {Mathematics}  % or Mathematics-Economics/Technology
\def \projectperiod      {Spring Semester 2022}
\def \projectnumber      {P6}
...
\include{main/codes/index}
\include{main/algebraic_geometry/index}
\include{main/algebraic_geometry_codes/index}
